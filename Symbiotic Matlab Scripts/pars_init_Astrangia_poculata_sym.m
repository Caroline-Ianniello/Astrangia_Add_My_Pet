...
par.T_A = 13357.92 ;  free.T_A   = 1;   units.T_A = 'K';          label.T_A = 'Arrhenius temperature'; 
...
%par.kap_R = 0.95;     free.kap_R = 0;   units.kap_R = '-';        label.kap_R = 'reproduction efficiency'; %0
par.p_M = 80;        free.p_M   = 1;   units.p_M = 'J/d.cm^3';   label.p_M = '[p_M], vol-spec somatic maint'; %100
...
%par.s_G = 0.0001;     free.s_G   = 0;   units.s_G = '-';          label.s_G = 'Gompertz stress coefficient'; %0
%% other parameters 
par.T_AH = 31384.53  ;  free.T_AH  = 1;   units.T_AH = 'K';         label.T_AH = 'Arrhenius temperature for upper boundary'; 
%par.T_AH = 35096.2457 ;  free.T_AH  = 1;   units.T_AH = 'K';         label.T_AH = 'Arrhenius temperature for upper boundary'; 
par.T_H = 299.66;       free.T_H   = 0;   units.T_H = 'K';          label.T_H = 'upper boundary tolerance range'; %0
...
par.del_Mi = 1;   free.del_Mi = 1;   units.del_Mi = '-';        label.del_Mi = 'shape coefficient for adult (ultimate)'; 
