...
par.T_A = 13357.91;  free.T_A   = 1;   units.T_A = 'K';          label.T_A = 'Arrhenius temperature'; 
par.z = 0.1;      free.z     = 1;   units.z = '-';            label.z = 'zoom factor'; 
%par.z = 0.13;      free.z     = 1;   units.z = '-';            label.z = 'zoom factor'; 
...
%par.kap_R = 0.95;     free.kap_R = 0;   units.kap_R = '-';        label.kap_R = 'reproduction efficiency'; 
par.p_M = 70;        free.p_M   = 1;   units.p_M = 'J/d.cm^3';   label.p_M = '[p_M], vol-spec somatic maint'; 
...
par.E_Hb = 4.581e-5; free.E_Hb  = 0;   units.E_Hb = 'J';         label.E_Hb = 'maturity at birth'; 
%par.E_Hb = 4e-5; free.E_Hb  = 1;   units.E_Hb = 'J';         label.E_Hb = 'maturity at birth'; 
...
%% other parameters 
par.T_AH = 31384.54 ;  free.T_AH  = 1;   units.T_AH = 'K';         label.T_AH = 'Arrhenius temperature for upper boundary'; 
%par.T_AH = 36652.72 ;  free.T_AH  = 1;   units.T_AH = 'K';         label.T_AH = 'Arrhenius temperature for upper boundary'; 

par.T_H = 299.66;       free.T_H   = 0;   units.T_H = 'K';          label.T_H = 'upper boundary tolerance range'; 
%par.T_H = 302.35;       free.T_H   = 0;   units.T_H = 'K';          label.T_H = 'upper boundary tolerance range'; 

%par.Wd0 = 0.005;        free.Wd0   = 0;   units.Wd0 = 'g';
%label.Wd0 = 'initial dry weight in tW data'; %0
par.del_M =0.455;  free.del_M = 0;   units.del_M = '-';        label.del_M = 'shape coefficient for larvae'; 
