...
%par.kap_P = 0.1;      free.kap_P = 0;   units.kap_P = '-';        label.kap_P = 'faecation efficiency of food to faeces'; %0
par.v = 0.04;            free.v     = 0;   units.v = 'cm/d';         label.v = 'energy conductance'; %0.02
...
%par.kap_R = 0.95;     free.kap_R = 0;   units.kap_R = '-';        label.kap_R = 'reproduction efficiency'; %0
par.p_M = 300;        free.p_M   = 1;   units.p_M = 'J/d.cm^3';   label.p_M = '[p_M], vol-spec somatic maint'; %100
...
%par.s_G = 0.0001;     free.s_G   = 0;   units.s_G = '-';          label.s_G = 'Gompertz stress coefficient'; %0
%% other parameters 
par.T_AH = 32223.71  ;  free.T_AH  = 0;   units.T_AH = 'K';         label.T_AH = 'Arrhenius temperature for upper boundary'; 
...
par.del_M = 0.22;   free.del_M = 0;   units.del_M = '-';        label.del_M = 'shape coefficient for larvae and egg'; 
